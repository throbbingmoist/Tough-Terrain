package net.moist.recipe.serializers;
...
public class TransformSerializer implements RecipeSerializer<TransformRecipe> {
	...
	public static final MapCodec<TransformRecipe.ParticleData> PARTICLE_MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
		ResourceLocation.CODEC.optionalFieldOf("particle").forGetter(x -> {return Optional.ofNullable(x.location());}),
		Codec.INT.optionalFieldOf("count").forGetter(x -> {return Optional.ofNullable(x.count());})
	).apply(instance, (x, y) -> new TransformRecipe.ParticleData(x.orElse(null), y.orElse(null))));
	...
	public static final MapCodec<TransformRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
		...
		PARTICLE_MAP_CODEC.codec().optionalFieldOf("particle").forGetter(TransformRecipe::getParticleDataOptional),
