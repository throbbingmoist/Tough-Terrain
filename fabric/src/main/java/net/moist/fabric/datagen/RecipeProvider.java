...
public class RecipeProvider extends FabricRecipeProvider {
	...
	public void buildRecipes(RecipeOutput exporter) {
		createLayerRecipes(exporter, ModBlocks.LOOSE_DIRT.placedLayer());
		createLayerRecipes(exporter, ModBlocks.LOOSE_SAND.placedLayer());
		...
		TransformRecipe.builder()
			.input(ModBlocks.LOOSE_DIRT.getPlacedLayer()).result(Blocks.DIRT).transformItem(Ingredient.of(Items.POTION))
			.sound(SoundEvents.BOTTLE_EMPTY).particles(ParticleTypes.SPLASH, 75)
			.build("transform_dirt_with_bottle", exporter);

		TransformRecipe.builder()
			.input(ModBlocks.LOOSE_SAND.getPlacedLayer()).result(Blocks.SAND).transformItem(Ingredient.of(Items.POTION))
			.sound(SoundEvents.BOTTLE_EMPTY).particles(ParticleTypes.SPLASH, 75)
			.build("transform_sand_with_bottle", exporter);

		TransformRecipe.builder()
			.input(ModBlocks.LOOSE_RED_SAND.getPlacedLayer()).result(Blocks.RED_SAND).transformItem(Ingredient.of(Items.POTION))
			.sound(SoundEvents.BOTTLE_EMPTY).particles(ParticleTypes.SPLASH, 75)
			.build("transform_red_sand_with_bottle", exporter);

		TransformRecipe.builder()
			.input(ModBlocks.LOOSE_GRAVEL.getPlacedLayer()).result(Blocks.GRAVEL).transformItem(Ingredient.of(Items.POTION))
			.sound(SoundEvents.BOTTLE_EMPTY).particles(ParticleTypes.SPLASH, 75)
